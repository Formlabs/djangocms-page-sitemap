...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageSitemapProperties'
        db.create_table(u'djangocms_page_sitemap_pagesitemapproperties', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_extension', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_extension', unique=True, null=True, to=orm['djangocms_page_sitemap.PageSitemapProperties'])),
            ...
            ('changefreq', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1, blank=True)),
        ))
        db.send_create_signal(u'djangocms_page_sitemap', ['PageSitemapProperties'])


    def backwards(self, orm):
        # Deleting model 'PageSitemapProperties'
        db.delete_table(u'djangocms_page_sitemap_pagesitemapproperties')
    ...
    models = {
        ...
        u'djangocms_page_sitemap.pagesitemapproperties': {
            ...
            'changefreq': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
